...
#Replace file name in this code with your actual file name for your Limma output from either Maycox or Iwamoto with gene annotation.
#May want to find and replace variable names in code too with something that makes sense....
...
#For this code to work, replace "Coef.DepressionModel" with whatever the name of the column with the Coefficient/estimate/beta/log2FC from the limma output
