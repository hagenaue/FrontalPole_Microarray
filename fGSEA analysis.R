...
Iwamoto_Model3_NoAnnotation<-read.csv("Limma_results_Model_Diagnosis_pH_RNADeg_RateofDeath_Age_PMI_Gender.csv", header=TRUE, stringsAsFactors = FALSE)
Iwamoto_Model3<-cbind.data.frame(Iwamoto_Model3_NoAnnotation, Iwamoto_Annotation)
dim(Iwamoto_Model3)
colnames(Iwamoto_Model3)
str(Iwamoto_Model3)
...
Maycox_Model3_NoAnnotation<-read.csv("Limma_results_Model_Diagnosis_pH_Age_RNADeg_PMI_Gender_ScanDateDayOnly.csv", header=TRUE, stringsAsFactors = FALSE)
Maycox_Model3<-cbind.data.frame(Maycox_Model3_NoAnnotation, Maycox_Annotation)
dim(Maycox_Model3)
colnames(Maycox_Model3)
str(Maycox_Model3)
...
sum(is.na(Iwamoto_Model3$GeneSymbol))
# [1] 67
Iwamoto_Model3_noNA<-Iwamoto_Model3[is.na(Iwamoto_Model3$GeneSymbol)==FALSE,]
dim(Iwamoto_Model3_noNA)
...
sum(is.na(Maycox_Model3$GeneSymbol))
# [1] 68
Maycox_Model3_noNA<-Maycox_Model3[is.na(Maycox_Model3$GeneSymbol)==FALSE,]
dim(Maycox_Model3_noNA)
...
# [1] 0
sum(duplicated(Iwamoto_Model3_noNA$GeneSymbol))
# [1] 0
sum(duplicated(Maycox_Model1_noNA$GeneSymbol))
# [1] 0
sum(duplicated(Maycox_Model2_noNA$GeneSymbol))
# [1] 0
sum(duplicated(Maycox_Model3_noNA$GeneSymbol))
# [1] 0
...
Iwamoto_Model3_BP_log2FC_forGSEA<-tapply(X=Iwamoto_Model3_noNA$Coef.DiagnosisFactorBipolar, INDEX=Iwamoto_Model3_noNA$GeneSymbol, FUN=mean)
...
names(Iwamoto_Model3_BP_log2FC_forGSEA)<-names(table(Iwamoto_Model3_noNA$GeneSymbol))

length(Iwamoto_Model1_BP_log2FC_forGSEA)
# [1] 8484
length(Iwamoto_Model2_BP_log2FC_forGSEA)
# [1] 8484
length(Iwamoto_Model3_BP_log2FC_forGSEA)
# [1] 8484
...
Iwamoto_Model3_BP_log2FC_forGSEA_Ranked<-Iwamoto_Model3_BP_log2FC_forGSEA[order(Iwamoto_Model3_BP_log2FC_forGSEA)]
head(Iwamoto_Model3_BP_log2FC_forGSEA_Ranked)
...
Iwamoto_Model3_Depression_log2FC_forGSEA<-tapply(X=Iwamoto_Model3_noNA$Coef.DiagnosisFactorDepression, INDEX=Iwamoto_Model3_noNA$GeneSymbol, FUN=mean)
...
names(Iwamoto_Model3_Depression_log2FC_forGSEA)<-names(table(Iwamoto_Model3_noNA$GeneSymbol))

length(Iwamoto_Model1_Depression_log2FC_forGSEA)
# [1] 8484
length(Iwamoto_Model2_Depression_log2FC_forGSEA)
# [1] 8484
length(Iwamoto_Model3_Depression_log2FC_forGSEA)
# [1] 8484
...
Iwamoto_Model3_Depression_log2FC_forGSEA_Ranked<-Iwamoto_Model3_Depression_log2FC_forGSEA[order(Iwamoto_Model3_Depression_log2FC_forGSEA)]
head(Iwamoto_Model3_Depression_log2FC_forGSEA_Ranked)
...
Iwamoto_Model3_Schiz_log2FC_forGSEA<-tapply(X=Iwamoto_Model3_noNA$Coef.DiagnosisFactorSchizophrenia, INDEX=Iwamoto_Model3_noNA$GeneSymbol, FUN=mean)
...
names(Iwamoto_Model3_Schiz_log2FC_forGSEA)<-names(table(Iwamoto_Model3_noNA$GeneSymbol))

length(Iwamoto_Model1_Schiz_log2FC_forGSEA)
# [1] 8484
length(Iwamoto_Model2_Schiz_log2FC_forGSEA)
# [1] 8484
length(Iwamoto_Model3_Schiz_log2FC_forGSEA)
# [1] 8484
...
Iwamoto_Model3_Schiz_log2FC_forGSEA_Ranked<-Iwamoto_Model3_Schiz_log2FC_forGSEA[order(Iwamoto_Model3_Schiz_log2FC_forGSEA)]
head(Iwamoto_Model3_Schiz_log2FC_forGSEA_Ranked)
...
Maycox_Model3_Schiz_log2FC_forGSEA<-tapply(X=Maycox_Model3_noNA$Coef.DiagnosisFactorScz, INDEX=Maycox_Model3_noNA$GeneSymbol, FUN=mean)
...
names(Maycox_Model3_Schiz_log2FC_forGSEA)<-names(table(Maycox_Model3_noNA$GeneSymbol))

length(Maycox_Model1_Schiz_log2FC_forGSEA)
# [1] 8484
length(Maycox_Model2_Schiz_log2FC_forGSEA)
# [1] 8484
length(Maycox_Model3_Schiz_log2FC_forGSEA)
# [1] 8484
...
Maycox_Model3_Schiz_log2FC_forGSEA_Ranked<-Maycox_Model3_Schiz_log2FC_forGSEA[order(Maycox_Model3_Schiz_log2FC_forGSEA)]
head(Maycox_Model3_Schiz_log2FC_forGSEA_Ranked)
...
Iwamoto_Model3_BP_FGSEAResults<-fgsea(GMT, Iwamoto_Model3_BP_log2FC_forGSEA_Ranked, nperm=50000, minSize = 10, maxSize = 1000)
str(Iwamoto_Model3_BP_FGSEAResults)
Iwamoto_Model3_BP_FGSEAResults$leadingEdge<-vapply(Iwamoto_Model3_BP_FGSEAResults$leadingEdge, paste, collapse= ",", character(1L))
write.csv(Iwamoto_Model3_BP_FGSEAResults, "Iwamoto_Model3_BipolarDisorder_FGSEAResults.csv")
...
Iwamoto_Model3_Depression_FGSEAResults<-fgsea(GMT, Iwamoto_Model3_Depression_log2FC_forGSEA_Ranked, nperm=50000, minSize = 10, maxSize = 1000)
str(Iwamoto_Model3_Depression_FGSEAResults)
Iwamoto_Model3_Depression_FGSEAResults$leadingEdge<-vapply(Iwamoto_Model3_Depression_FGSEAResults$leadingEdge, paste, collapse= ",", character(1L))
write.csv(Iwamoto_Model3_Depression_FGSEAResults, "Iwamoto_Model3_Depression_FGSEAResults.csv")
...
Iwamoto_Model3_Schiz_FGSEAResults<-fgsea(GMT, Iwamoto_Model3_Schiz_log2FC_forGSEA_Ranked, nperm=50000, minSize = 10, maxSize = 1000)
str(Iwamoto_Model3_Schiz_FGSEAResults)
Iwamoto_Model3_Schiz_FGSEAResults$leadingEdge<-vapply(Iwamoto_Model3_Schiz_FGSEAResults$leadingEdge, paste, collapse= ",", character(1L))
write.csv(Iwamoto_Model3_Schiz_FGSEAResults, "Iwamoto_Model3_Schizophrenia_FGSEAResults.csv")
...
Maycox_Model3_Schiz_FGSEAResults<-fgsea(GMT, Maycox_Model3_Schiz_log2FC_forGSEA_Ranked, nperm=50000, minSize = 10, maxSize = 1000)
str(Maycox_Model3_Schiz_FGSEAResults)
Maycox_Model3_Schiz_FGSEAResults$leadingEdge<-vapply(Maycox_Model3_Schiz_FGSEAResults$leadingEdge, paste, collapse= ",", character(1L))
write.csv(Maycox_Model3_Schiz_FGSEAResults, "Maycox_Model3_Schizophrenia_FGSEAResults.csv")
